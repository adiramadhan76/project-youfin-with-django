...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('youfin_app', '0008_budget_remaining_balance_alter_budget_initial_budget'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='budget',
            name='bulan',
            field=models.IntegerField(choices=[(1, 'Januari'), (2, 'Februari'), (3, 'Maret'), (4, 'April'), (5, 'Mei'), (6, 'Juni'), (7, 'Juli'), (8, 'Agustus'), (9, 'September'), (10, 'Oktober'), (11, 'November'), (12, 'Desember')], default=12),
        ),
        migrations.AddField(
            model_name='budget',
            name='tahun',
